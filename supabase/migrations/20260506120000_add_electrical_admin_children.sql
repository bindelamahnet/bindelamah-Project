...
cross join (
  values
    ('0.1.1.9.1', 'إعدادات الأوامر', 'menu-0-1-1-9-1', 121),
    ('0.1.1.9.2', 'إعدادات المستودع', 'menu-0-1-1-9-2', 122),
    ('0.1.1.9.3', 'المناطق والمدن', 'menu-0-1-1-9-3', 123),
    ('0.1.1.9.4', 'إعدادات النظام', 'menu-0-1-1-9-4', 124)
