...
cross join (
  values
    ('0.1.1.3.1', 'إعدادات الموارد', 'menu-0-1-1-3-1', 61),
    ('0.1.1.3.2', 'بيانات الموظفين', 'menu-0-1-1-3-2', 62),
    ('0.1.1.3.3', 'طلبات الإجازات', 'menu-0-1-1-3-3', 63),
    ('0.1.1.3.4', 'بيانات المعدات', 'menu-0-1-1-3-4', 64),
    ('0.1.1.3.5', 'تكلفة الفرق', 'menu-0-1-1-3-5', 65),
    ('0.1.1.3.6', 'معدات السلامة', 'menu-0-1-1-3-6', 66),
    ('0.1.1.3.7', 'إحصائيات', 'menu-0-1-1-3-7', 67),
    ('0.1.1.3.8', 'نماذج وتقارير', 'menu-0-1-1-3-8', 68)
) as item(wbs_code, name_ar, slug, sort_order)
where parent.wbs_code = '0.1.1.3'
