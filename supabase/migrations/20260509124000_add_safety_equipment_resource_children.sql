...
cross join (
  values
    ('0.1.1.3.6.1', 'تسليم معدات السلامة', 'menu-0-1-1-3-6-1', 661),
    ('0.1.1.3.6.2', 'إدارة أنواع معدات السلامة', 'menu-0-1-1-3-6-2', 662),
    ('0.1.1.3.6.3', 'تقرير التسليم', 'menu-0-1-1-3-6-3', 663)
) as item(wbs_code, name_ar, slug, sort_order)
where parent.wbs_code = '0.1.1.3.6'
...
where parent.wbs_code = '0.1.1.3.6'
  and child.wbs_code in ('0.1.1.3.6.1', '0.1.1.3.6.2', '0.1.1.3.6.3')
