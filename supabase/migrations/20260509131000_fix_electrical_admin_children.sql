...
cross join (
  values
    ('0.1.1.9.1', U&'\0625\0639\062f\0627\062f\0627\062a \0627\0644\0623\0648\0627\0645\0631', 'menu-0-1-1-9-1', 121),
    ('0.1.1.9.2', U&'\0625\0639\062f\0627\062f\0627\062a \0627\0644\0645\0633\062a\0648\062f\0639', 'menu-0-1-1-9-2', 122),
    ('0.1.1.9.3', U&'\0627\0644\0645\0646\0627\0637\0642 \0648\0627\0644\0645\062f\0646', 'menu-0-1-1-9-3', 123),
    ('0.1.1.9.4', U&'\0625\0639\062f\0627\062f\0627\062a \0627\0644\0646\0638\0627\0645', 'menu-0-1-1-9-4', 124)
) as item(wbs_code, name_ar, slug, sort_order)
where parent.wbs_code = '0.1.1.9'
...
where parent.wbs_code = '0.1.1.9'
  and child.wbs_code in ('0.1.1.9.1', '0.1.1.9.2', '0.1.1.9.3', '0.1.1.9.4')
